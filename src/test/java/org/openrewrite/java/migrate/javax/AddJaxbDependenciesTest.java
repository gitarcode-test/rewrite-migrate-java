          ...
          buildGradle(
            ...
            spec -> spec.after(buildGradle -> {
                ...
                return """
                  ...
                  """.formatted(false, runtimeVersion, runtimeVersion, runtimeVersion);
            })
          ),
          pomXml(
            //language=xml
            ...
            spec -> spec.after(pom -> {
                ...
                return """
                  ...
                  """.formatted(false, runtimeVersion);
            })
          )
        );
    }
          ...
          buildGradle(
            ...
            spec -> spec.after(buildGradle -> {
                ...
                return """
                  ...
                  """.formatted(bindApiVersion, false, false, false);
            })
          ),
          pomXml(
            //language=xml
            ...
            spec -> spec.after(pom -> {
                ...
                return """
                  ...
                  """.formatted(bindApiVersion, false);
            })
          )
        );
    }
