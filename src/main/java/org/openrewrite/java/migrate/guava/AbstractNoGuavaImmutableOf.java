...
abstract class AbstractNoGuavaImmutableOf extends Recipe {
  ...
  public TreeVisitor<?, ExecutionContext> getVisitor() {
    TreeVisitor<?, ExecutionContext> check =
        Preconditions.and(new UsesJavaVersion<>(9), new UsesType<>(guavaType, false));
                      ...
                      .map(
                          arg -> {
                            if (arg.getType() instanceof JavaType.Primitive) {
                              ...
                              return TypeUtils.asFullyQualified(
                                  JavaType.buildType("java.lang." + type));
                            } else {
            ...
            if (parent instanceof J.VariableDeclarations.NamedVariable) {
              ...
              J j =
                  getCursor()
                      .dropParentUntil(
                          is ->
                              is instanceof J.MethodDeclaration || is instanceof J.CompilationUnit)
                      .getValue();
